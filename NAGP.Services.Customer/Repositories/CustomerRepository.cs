    ...
    public class CustomerRepository
    {
        ...
        public CustomerRepository()
        {
            customers = new List<Customer>
            {
                ...
                new Customer{Id = 1, Name ="amit", Username="amit@123", Password="amit@123", ContactNumber="9871778931", Address="Dwarka, Delhi"},
                new Customer{Id = 1, Name ="ronit", Username="ronit@123", Password="ronit@123", ContactNumber="9871778942", Address="Gurugram, Haryana"},
                new Customer{Id = 1, Name ="tina", Username="tina@123", Password="tina@123", ContactNumber="9871778932", Address="Noida, UP"},
            };
        }
